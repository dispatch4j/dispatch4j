...
class Dispatch4jFactoryTest {
    ...
    class BasicFactoryCreation {
        ...
        void shouldCreateDispatcherWithMultiplePackages() {
            // When
            var dispatcher =
                    Dispatch4jFactory.create("io.github.dispatch4j.standalone", "com.example");
    ...
    class AsyncOperations {
        ...
        void setUp() {
            dispatcher =
                    Dispatch4jFactory.create(
                            ForkJoinPool.commonPool(), "io.github.dispatch4j.standalone");
        }
    ...
    class PackageScanning {
        ...
        void shouldScanMultiplePackagesCorrectly() {
            ...
            var dispatcher =
                    Dispatch4jFactory.create(
                            "io.github.dispatch4j.standalone", "com.nonexistent.package");
