...
public interface Dispatcher {
   ...
   *
   * <p>Events can have zero, one, or multiple handlers. If no handlers are registered, a warning is
   ...
   *
   * <p>This method returns immediately with a {@link CompletableFuture} that will complete when all
   * handlers have finished processing the event.
   *
   * @param event the event to publish (must not be null)
